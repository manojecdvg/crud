...
use Doctrine\Common\ClassLoader, Doctrine\ORM\Tools\Setup, Doctrine\ORM\EntityManager;

/**
 * Doctrine bootstrap library for CodeIgniter
 *
 * @author Manoj <manoj@za.oasiscrescent.com>
...
class Doctrine {
	...
	public function __construct() {
		...
		// If you want to use a different metadata driver, change
