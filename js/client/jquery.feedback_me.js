...
var fm = (function ($) {
	...
	function appendFeedbackToBody(fm_options) {
		var form_html = "",
			...
			email_html = "",
			contact_html = "",
			contact_feedback_content_class = "",
			...
			contact_required = fm_options.contact_required ? "required" : "",
			...
			contact_asterisk  = fm_options.contact_required && fm_options.show_asterisk_for_required ? "<span class=\"required_asterisk\">*</span>" : "",
...
if (fm_options.show_contact) {
			contact_html = '<li><label for="feedback_contact">' + fm_options.contact_label + '</label> ' + contact_asterisk + '<input type="text" class="feedback_contact" ' + contact_required + ' placeholder="' + fm_options.contact_placeholder + '"></input> </li>';
			contact_feedback_content_class = " email_present";
		}
		...
		if (fm_options.show_form === true) {
			...
			+		 contact_html	+		 email_html

				+		'<li>	<label for="feedback_message">' + fm_options.message_label + '</label> ' + message_asterisk + ' <textarea rows="3" class="feedback_message" ' + message_required + ' placeholder="' + fm_options.message_placeholder + '"></textarea> </li>'
	...
	function clearInputs(event) {
		...
		$fm_content.find(".feedback_contact").val("");
	...
	function sendFeedback(event, position) {
		...
		dataArray = {
			...
			contact: $fm_content.find(".feedback_contact").val(),
